...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.set_window_size(1218, 1069)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Goodness")
    self.driver.find_element(By.ID, "password").send_keys("Goodness321223")
  ...
  def test_homePageTest1(self):
    ...
    self.driver.set_window_size(855, 1069)
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Goodness")
    self.driver.find_element(By.NAME, "lname").send_keys("Okafor")
    self.driver.find_element(By.NAME, "bizname").send_keys("Heavenly Aura")
